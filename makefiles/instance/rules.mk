...
ifneq ($(THEOS_VENDOR_LIBRARY_PATH),)
	...
	_THEOS_INTERNAL_OBJCFLAGS += -F$(THEOS_LIBRARY_PATH)
	_THEOS_INTERNAL_SWIFTFLAGS += -F$(THEOS_LIBRARY_PATH)
	_THEOS_INTERNAL_LDFLAGS += -F$(THEOS_LIBRARY_PATH)
endif
...
_LOCAL_USE_SUBSTRATE = $(or $($(THEOS_CURRENT_INSTANCE)_USE_SUBSTRATE),$(_THEOS_TARGET_DEFAULT_USE_SUBSTRATE),$(_THEOS_FALSE))
ifneq ($(call __theos_bool,$(_LOCAL_USE_SUBSTRATE)),$(_THEOS_TRUE))
